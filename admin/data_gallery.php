...
<!-- Sidebar -->
                ...
                <li><a href="logout.php" onclick="return confirm('Apakah anda yakin ingin keluar?');"class="block text-red-600 hover:underline fontmedium">Logout</a></li>
</ul>
</aside>
<!-- Main Content -->
            ...
            <a href="add_gallery.php" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">+ Tambah Gallery</a>
            </div>
...
<?php
            ...
            echo "<img src='../image/{$data['foto']}' class='w-full h-48 object-cover'>";
            echo "<div class='p-4'>";
